...
export default function List({ fetchTocfl, loading }) {
    ...
    const filteredItems = useMemo(() => {
        ...
        let filteredByTags = shouldFilterByTags ? filteredByLevel.filter(item => item.tags.some(tag => selectedTags.includes(tag))) : filteredByLevel;
